...
import com.mcuhq.simplebluetooth.Activity_Login;
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        ...
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                                ...
                                birthdayText.setText(year + "년 " + (month + 1) + "월 " + dayOfMonth + "일");
                                birthdayCheck = true;
                            }
                        }, year, month, day
                );
...
//                datePickerDialog.setTitle("생년월일을 선택하세요");
        ...
        completeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameCheck && heightCheck && weightCheck && genderCheck && birthdayCheck) {
                    ...
                    // API 호출
                    serverManager.signupTask(email, pw, name, gender, height, weight, String.valueOf(age), birthday, new ServerManager.ServerTaskCallback() {
                        @Override
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Signup_Fourth.this);
                    builder.setTitle("알림")
                            .setMessage(alertString.substring(0, alertString.length() - 2) + "을(를)\n다시 입력해주세요")
                            .setNegativeButton("확인", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    // 취소 버튼 클릭 시 수행할 동작
                                    dialog.cancel(); // 팝업창 닫기
    ...
    public void SaveUserData() {
        ...
        editor.putBoolean("s_emergency", true);
        editor.putBoolean("s_arr", true);
        editor.putBoolean("s_drop", true);
        editor.putBoolean("s_muscle", false);
        editor.putBoolean("s_slowarr", false);
        editor.putBoolean("s_fastarr", false);
        editor.putBoolean("s_irregular", false);
...
//        }
    ...
    public void setHintText() {
        ...
        String nameHintText = "성함을 입력해주세요";
        String heightHintText = "신장을 입력해주세요";
        String weightHintText = "몸무게를 입력해주세요";
